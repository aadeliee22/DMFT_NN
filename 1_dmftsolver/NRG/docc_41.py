...
T = args.T
lamb = args.lamb
filename = f'./B_41_{lamb:.1f}/Bethe-{U:.2f}.dat'
w, Aw, Gwr, Gwi, Swr, Swi = np.loadtxt(filename, unpack = True, dtype = 'complex128')


sub.run(['g++', 'docc_41.cpp', '-o', 'docc41', '-I/home/hyejin/fftw-3.3.9', '-L/opt/fftw/lib', '-lfftw3', '-std=gnu++11'])
beta = 1.0/T
N = 80000
